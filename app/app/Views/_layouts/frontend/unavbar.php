...
<html lang="en" class="language <?php echo $lang; ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('public/frontend/'); ?>/css/main.css?v=1.1">
                    ...
                    <div class="offcanvas__content">
                        <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                            <div class="offcanvas__logo logo">
                                ...
                                <img src="<?php echo base_url('public/frontend/'); ?>img/logo/logo.png" style="width:220px;" alt="logo">
                                </a>
                            </div>
                            ...
                            <div class="bd-action__item">
                                <div class="bd-action__cart-wrapper">
                                    <div class="bd-action__cart-icon">
                                        <a href="#" class="cart-dropdowna" data-bs-toggle="offcanvas" data-bs-target="#cartmini"
                                            aria-controls="cartmini">
                                            <svg id="shopping-bag-5564" xmlns="http://www.w3.org/2000/svg" width="16.508"
                            ...
                            <div class="bd-action__item">
                                <div class="bd-action__wishlist">
                                    <div class="bd-action__wistlist-icon">
                                        <a href="#" class="cart-dropdowna" data-bs-toggle="offcanvas" data-bs-target="#wishlist"
                        ...
                        <div class="offcanvas__contact mt-30 mb-20">
                            ...
                            <ul>
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="tel:+012-345-6789"><span class="#"><span class="__cf_email__">contact@food.com</span></span></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="style-2">
                            <div class="bd-treak__right bd-header__top-link">
                                ...
                                <?php if (!empty($user_data)): ?>
                                    <a href="javascript:void(0);" class="link-to-tab d-md-show">Welcome <?php echo $user_data[0]['first_name']; ?></a>
            ...
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-6 col-6">
                    <div class="bd-header__logo-3">
                        <a href="<?php echo base_url(''); ?>">
                        <img src="<?php echo base_url('public/frontend/'); ?>img/logo/logo.png" class="logo_main" alt="logo">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="bd-header__left-3">
                        <div class="main-menu d-none d-none d-lg-block">
                            <nav id="mobile-menu">
                                <ul>
                                    <li class="">
                                        <a href="<?php echo base_url(''); ?>"><?php echo lang('Validation.Home') ?></a>
                                    </li>
                                    <li class="has-dropdown">
                                        <a href="<?php echo base_url('products/'); ?>"><?php echo lang('Validation.Categories') ?></a>
                                        <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);"><?php echo lang('Validation.Contact Us') ?></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="bd-header__right header__right-3">
                        <div class="bd-action__filter-wrapper d-none d-xl-block">
                            <div class="bd-action__filter p-relative">
                                <form action="javascript:void(0);">
                                    <input id="search_me" class="search_header" type="text" placeholder="<?php echo lang('Validation.Search products') ?>...">
                        ...
                        <div class="arbc_lang">
                            ...
                            <?php foreach ($lang_data as $ld_key => $ld_val) { ?>
                                <a href="javascript:void(0)" class=" contry_flag lang_change <?php echo $ld_val['is_active']; ?>" data-id="<?php echo $ld_val['lang_nm']; ?>">
                        ...
                        <div class="bd-action__cart-list list-3">
                            <div class="bd-action__item">
                                <div class="bd-action__cart-wrapper">
                                    <div class="bd-action__cart-icon">
                                        <a href="#" data-bs-toggle="offcanvas" class="cart-dropdowna" data-bs-target="#cartmini"
                                            aria-controls="cartmini">
                                            <svg id="shopping-bag-5" xmlns="http://www.w3.org/2000/svg" width="16.508"
                                                height="18.5" viewBox="0 0 16.508 18.5">
                                    ...
                                    <a class="downl_brchr" href="<?php echo base_url('public/pdf/foodyfood.pdf') ?>" target="_blank" ><?php echo lang('Validation.View Catalog') ?></a>
                                </div>
                            </div>
                        </div>
