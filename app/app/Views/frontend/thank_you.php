...
<main class="main home mt-lg-1 mb-1">
    <div class="page-content" style="display:none;">
        <div class="cart_icn_as">
            <!-- <div class="cart_in">
                <i class="fa fa-thumbs-up" aria-hidden="true"></i>
            </div> -->
            <div class="crt_empty">
                Thank You <?php echo $data['name']; ?>,<br>Order Placed Successfully
            </div>
            <br>
        </div>
    </div>
    <section class="section-b-space" style="margin-top:30px;margin-bottom:-5px;">
        <div class="container">
            <div class="row">
