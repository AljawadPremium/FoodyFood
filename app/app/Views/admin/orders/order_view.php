                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class=" res_div col-sm-3">
                                            ...
                                            <input type="hidden" class="d_order_id" value="<?php echo en_de_crypt($orders['display_order_id']); ?>">
                                            ...
                                            <select  class="o_status form-control"  name="order_status" >
                                                ...
                                                <option value="Accepted" <?php if( $order_status == "Accepted" ) echo "Selected"; ?> >Accepted</option>
                                        ...
                                        <div class=" res_div col-sm-3">
                                            <label>Driver</label>
                                            <select  class="form-control driver_select" name="driver_id">
                                                <option value="">Select Driver</option>
                                                <?php if (!empty($driver_list)): ?>
                                                <?php foreach ($driver_list as $dkey => $dvalue): ?>
                                                <option value="<?php echo $dvalue['id']; ?>" <?php if( isset($driver_id) && $driver_id == $dvalue['id'] ) echo "Selected"; ?> ><?php echo $dvalue['first_name']; ?></option>
                                                <?php endforeach ?>
                                                <?php endif ?>
                                            </select>
                                        </div>
                                        <div class=" res_div col-sm-3">
                                            <div class="add-group btn_icon" style="margin-top: 10px;">
                                                <br>
                                                <button title="Print order">
                                                <a target="_blank" href="<?php echo base_url("invoice/print/") ?><?php echo $orders['order_id']; ?>"><i class="fa fa-print"></i></a>
                                                </button>
                                                <button title="Invoice download">
                                                <a href="<?php echo base_url("invoice/pdf/") ?><?php echo $orders['order_id']; ?>"><i class="fa fa-download"></i></a>
                                                </button>
                                                <button title="Send notification">
                                                <a class="o_edit_s" data-toggle="modal" data-target="#o_edit_model"><i class="fa fa-bell"></i></a>
                                                </button>
                                                <!-- <button title="Send payment link">
                                                    <a data-id="<?php echo en_de_crypt($orders['display_order_id']); ?>" href="javascript:void(0);" class="order_payment_link" class=""><i class="fa fa-credit-card"></i></a>
                                                    </button>
                                                    
                                                    <button title="QR code">
                                                    <a id="clickBtn" data-id="<?php echo en_de_crypt($orders['display_order_id']); ?>" href="javascript:void(0);" class="qr_code" class=""><i class="fa fa-qrcode"></i></a>
                                                    </button> -->
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="o_box">
                                                ...
                                                <div class="o_labe"> <?php echo $currency; ?> <?php echo $orders['net_total']; ?> </div>
                                            </div>
                                            <div class="o_box">
                                            ...
                                            <table class="rwd-table">
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="td_label" colspan="1"><?php echo $currency; ?> <?php echo $orders['sub_total']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fle" colspan="7">Shipping Amount</td>
                                                        <td class="td_label" colspan="1"><?php echo $currency; ?> <?php echo $orders['shipping_charge']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fle" colspan="7">Tax Amount</td>
                                                        <td class="td_label" colspan="1"><?php echo $currency; ?> <?php echo $orders['tax']; ?></td>
                                                    </tr>
                                                    <?php if ($orders['tip_amount']): ?>
                                                    <tr>
                                                        <td class="fle" colspan="7">Tip amount</td>
                                                        <td class="td_label" colspan="1"><?php echo $currency; ?> <?php echo $orders['tip_amount']; ?></td>
                                                    </tr>
                                                    <?php endif ?>
                                                    <?php if ($orders['voucher_amount']): ?>
                                                    <tr>
                                                        <td class="fle" colspan="7">Voucher Amount (<?php echo $orders['voucher_code']; ?>)</td>
                                                        <td class="td_label" colspan="1"><?php echo $currency; ?> <?php echo $orders['voucher_amount']; ?></td>
                                                    </tr>
                                                    <?php endif ?>
                                                    <tr>
                                                        <td class="fle" colspan="7">Grand Total</td>
                                                        <td class="td_label" colspan="1"><?php echo $currency; ?> <?php echo $orders['net_total']; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
<script src='<?php echo base_url(); ?>public/admin/main_js/order_view.js'></script>