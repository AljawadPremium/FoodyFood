                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr class="pages_<?php echo en_de_crypt($value['id']); ?>">
                                        <td><?php echo $key+1; ?></td>
                                        <td><?php echo $value['title']; ?></td>
                                        <td class="action_tab">
                                            <!-- <a href="javascript:void(0);" data-id="<?php echo en_de_crypt($value['id']); ?>" class="delete_pages"><i class="action_tab fa fa-trash"></i></a> -->
                                            <a class="btn btn-primary btn-sm" href="<?php echo base_url('admin/pages/edit') ?>/<?php echo en_de_crypt($value['id']); ?>" target="_blank"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach ?>
                                    <?php endif ?>
...
<script src="<?php echo base_url();?>/public/admin/main_js/pages_listing.js"></script>