<?php 
$label = 'Add';
$display_name = $status = $image = $t_id = '';
if (!empty($edit)) 
{
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form class="edit_subcategory" method="post">
                                            <input type="hidden" class="edit_sub_id" name="edit_sub_id" value="<?php echo $t_id; ?>">
                                            <div class="row">
                                                
                                            <div class="col-sm-6">
                                                <label>Display Name</label>
                                                <textarea class="m_name form-control" rows="4" name="display_name" placeholder="Enter name" type="text"><?php echo $display_name; ?></textarea>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Status</label>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="showImage" style="background-image: url('<?php echo base_url('/public/admin/category/') ?><?php echo $image; ?>');">
                                                    <!-- <img src="<?php echo base_url('/public/admin/category/') ?><?php echo $image; ?>"> -->
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                            <div class="col-sm-6">
